...
| Tab | What it's for |
|---|---|
| **Dashboard** | Your daily home base — quick-log activities, see active plans |
| **Gyms** | Discover gyms on an interactive map |
| **Training** | Workout plans, diet plans, trainer search, and your trainees |
| **Tracker** | Your full activity history and workout details |
...
4. [Start tracking](tracker.md) — log from the Dashboard every day
