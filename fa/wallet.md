...
در صفحه کیف پول می‌توانید یک **شماره حساب بانکی** ذخیره کنید. درخواست‌های برداشت شما به همین حساب واریز می‌شود، پس پیش از ذخیره از درستی آن مطمئن شوید. هر زمان می‌توانید آن را به‌روزرسانی کنید — کافی است مقدار را ویرایش کرده و روی **ذخیره** بزنید.
